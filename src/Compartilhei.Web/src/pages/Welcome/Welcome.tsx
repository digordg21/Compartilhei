...
import cameraIcon
    from "../../assets/icons/botao-camera.svg"; //grou2.svg

import cameraText
    from "../../assets/welcome/icons/texto-12.svg";

import favoriteIcon
    from "../../assets/icons/ESTRELA.svg";

import favoriteText
    from "../../assets/welcome/icons/texto-13.svg";

import albumsIcon
    from "../../assets/icons/botao-album.svg";
            ...
            <section className="welcome__content">
                ...
                >
                    <span className="welcome__action-icon">
                        ...
                        <img
                            className="welcome__action-icon welcome__action-icon--camera"
                            src={cameraIcon}
                            alt=""
                            aria-hidden="true"
                        />
